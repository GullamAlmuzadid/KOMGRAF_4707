...
void display() {
    ...
    glColor3f(0.0, 1.0, 1.0); // Warna biru untuk titik A
    drawPoint(xAwal, yAwal);

    glColor3f(1.0, 0.0, 0.0); // Warna merah untuk titik B
...
int main(int argc, char **argv) {
    ...
    glutCreateWindow("Grafik Algoritma DLL");
    init();
    cout << "Masukkan Nilai di titik A :"<<endl;
    cout << "xAwal = ";
    cin >> xAwal;
    cout << "yAwal = ";
    cin >> yAwal;
    cout << "Masukkan Nilai di titik B :"<<endl;
    cout << "xAkhir = ";
    cin >> xAkhir;
    cout << "yAkhir = ";
    cin >> yAkhir;
